...
const ColorContainer = () => {
  return (
    <div id="colorcontainer">
      <CardComp frontText={textHomePage.FlipContainers[0].firstCardContainerFront} backtext={textHomePage.FlipContainers[0].firstCardContainerBack} buttonText="Läs mer" image={images[0].homeFirstCard} cardId="firstCard" toPage="/about" />
      <CardComp frontText={textHomePage.FlipContainers[0].secondCardContainerFront} backtext={textHomePage.FlipContainers[0].secondCardContainerBack} buttonText="Läs mer" image={images[0].homeSecondCard} cardId="secondCard" toPage="/contact" />
      <CardComp frontText={textHomePage.FlipContainers[0].thirdCardContainerFront} backtext={textHomePage.FlipContainers[0].thirdCardContainerBack} buttonText="Läs mer" image={images[0].homeThirdCard} cardId="thirdCard" toPage="/pricing" />
    </div>
  );
};
